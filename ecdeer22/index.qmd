...
1.  Hypothesis Tests: Knowledge of hypothesis tests are vital to this activity. Familarity with  hypothesises, test statistics, degrees of freedom, and p-values are important for the completion of this worksheet.
...
3.  Familiarity with basic statistical analysis techniques and terms, specifically mean, categorical variables, and quantatiatve variables, are imporatant conceptual concepts needed in the aiding in this activity.
:::
