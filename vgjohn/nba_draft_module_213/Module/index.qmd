...
Students should have prior knowledge of conducting one-way analysis of variance tests and the implications. Students should be able to explain the different components of an ANOVA table as well as familiarity with the formulas necessary to complete the table. Students should also be comfortable with the statistical software, R, such as know how to make basic data visualizations and statistical tests. 
...
[Class handout](nba_draft_worksheet.docx)

[Class handout - with solutions](nba_draft_worksheet_SOLUTIONS.docx)
