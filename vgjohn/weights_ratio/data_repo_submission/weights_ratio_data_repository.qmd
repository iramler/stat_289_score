...
[Flat dumbbell press](https://www.youtube.com/watch?v=XMc1N3o-Qyw){target="_blank"} is when the lifter lies on a flat bench with their arms positioned at roughly 45 degree angles, lifts two equal sized dumbbells, brings them back to the chest, and then keeps going. 

[Barbell bench press](https://www.youtube.com/watch?v=SCVCLChPQFY){target="_blank"} is when the lifter lies on a bench and lifts a horizontal bar (the barbell) with equal weighted plates on both sides and brings it back down to the chest.
...
: [weights_ratio.csv](../vgjohn/weights_ratio.csv)

## Questions

1.  Discuss concerns that arise because of the way the data was collected. How does this affect the audience the data applies to? 
2.  Construct a 95% confidence interval for the average weightlifter's ratio.
3.  Discuss ways a weightlifter could use their ratio to become more "balanced" 
5.  What steps would you take to make the data more reliable?
