...
This worksheet involves using the strength ratio to look at outliers, histograms, confidence intervals, and discuss the effect that data collection methods have on the variance and potential distribution of the data.
