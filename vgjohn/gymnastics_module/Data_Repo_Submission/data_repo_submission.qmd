...
2. [Uneven Bars](https://www.youtube.com/watch?v=j8N_xzlczQI){target="_blank"}: This is a routine in which the gymnast does a variety of flips and rotations on two horizontal bars that are set at different heights. The gymnast mounts onto a bar and the rountine consists of transitioning from one bar to the other while swinging and flipping. The rountine ends with a dismount off of the bar and onto the floor. 
...
: [ncaa_gymnastics.csv](Users/vivianjohnson/Desktop/stat_289_score_new/vgjohn/gymnastics_module/Data_Repo_Submission/ncaa_gymnastics.csv)

## Questions

1. Calculate the bootstrap statistic for the sample population

2. Create and comment on a bootstrap distribution. 

3. Create a confidence interval for the population statistic
