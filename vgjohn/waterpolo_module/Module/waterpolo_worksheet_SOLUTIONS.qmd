...
**1. What schools have leaders in both the assists category and the goals category, and how many of each does the school have in total? Create a table that contains the conference, number of goals, and number of assists. (Hint: Use a join() function)**
...
```
**2. What proportion of teams have leaders in both goals and assists?** 
