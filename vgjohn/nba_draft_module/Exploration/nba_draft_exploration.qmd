...
ggplot(nba_round1s,
  ...
  theme_minimal()
```
the skewness for 1-10 draft picks makes sense because they're going to teams that probably need them more and they're the "most talented" because they're ranked higher. 
...
ggplot(nba_round1s,
       mapping = aes(x = mins_per_game,
                     ...
                     fill = pick_category)) +
  geom_boxplot() +
  labs(title = "Boxplot of PPG based on Round 1 NBA draft picks",
       x = "Minutes Per Game",
