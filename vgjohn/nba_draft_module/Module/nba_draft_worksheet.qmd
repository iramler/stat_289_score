...
6. Can we conclude there is a difference in the mean amount of minutes played per game based on when a player was selected in the draft? Provide evidence. 

  * We can conclude that there is sufficient evidence to reject the null hypothesis that the mean number of minutes played per game is the same regardless of when a player was selected in the first round of the draft. The p-value given in the ANOVA table is $2*10^{-6}$ meaning there is strong evidence to reject the null hypothesis. 
  
7. In the 2011 NBA draft, Kawhi Leonard was selected 15th in the first round by the Indiana Pacers. Jimmy Butler was selected 30th in the first round by the Chicago Bulls. Based on the ANOVA table alone, do you think one player would play more/less minutes on average compared to the other? Why or why not. 

  * Based on the ANOVA table alone, you can't make the conclusion that one group is more/less than the other. You can only conclude that at least one of the averages are different. Therefore you can't conclude strictly from this test that one player would have more minutes compared to the other. To do that, another test would have to be done. (Such as Tukey's HSD or other post-hoc tests)
