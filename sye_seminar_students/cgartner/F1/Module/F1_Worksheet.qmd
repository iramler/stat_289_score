...
```
2). Notice how the graph doesn't appear to contain enough data points. There should be twenty data points from each of the 22 races. Why might this be the case? Add to the code to fix this.You will also have to fill out the code for selected_drivers as you did above. 
```{r}
# Define selected drivers
selected_drivers <- #ANSWER
