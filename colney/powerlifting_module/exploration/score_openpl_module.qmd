...
openpowerlifting <- read_csv(here::here("colney/powerlifting_module/exploration/openpowerlifting-2025-05-31-c2a0b8b0.csv"))
...
podium_female<-
  tidy %>%
  filter(Sex == "F")
write_csv(podium_female, "tidy_powerlift_female.csv")

```

```{r}
male <- read_csv(here::here("colney/powerlifting_module/exploration/tidy_powerlift_male.csv"))
female <- read_csv(here::here("colney/powerlifting_module/exploration/tidy_powerlift_female.csv"))
