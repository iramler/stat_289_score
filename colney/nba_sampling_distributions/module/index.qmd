...
At the heart of this title run was [Shai Gilgeous-Alexander (SGA)](https://en.wikipedia.org/wiki/Shai_Gilgeous-Alexander){target="_blank"}, who led the league in scoring, was named NBA MVP and capped off the season by earning the Finals MVP. His scoring consistency and ability to take over games made him one of the most dominant offensive forces in the league. This dataset, which contains SGA's point totals from every regular season game, offers a snapshot of one of the most impressive individual season in recent NBA history.
