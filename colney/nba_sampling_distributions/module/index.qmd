...
author:
  ...
  - name: Ivan Ramler
    ...
    affiliation:
      - ref: slu
date: "June __, 2025"
description: "Exploring sampling distribution for the sample mean by looking at Shai Gilgeous-Alexander's game-by-game 2024-25 regular season point totals."
editor: 
  canonical: true
categories:
...
At the heart of this title run was [Shai Gilgeous-Alexander (SGA)](https://en.wikipedia.org/wiki/Shai_Gilgeous-Alexander){target="_blank"}, who led the league in scoring, was NBA MVP and capped off the season by earning the Finals MVP. His scoring consistency and ability to take over games made him one of the most dominant offensive forces in the league. This dataset, which contains SGA's point totals from every regular season game, offers a snapshot of one of the most impressive individual season in recent NBA history.
...
2. Use simulation tools (StatKey) to create sampling distributions of the sample mean.
...
This activity uses Statkey or any similar sampling distribution tool.
...
[Class handout](/module/nba_sampling_dist_worksheet.qmd)

[Class handout - with solutions](/module/nba_sampling_dist_solutions.qmd)
