...
c.  After comparing the differences, use `mutate()` to correct the two misspelled names in the player profiles dataset. Then, recombine the datasets and this time there should be no mismatches.
