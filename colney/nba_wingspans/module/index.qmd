...
### Data
The **nba_player_profiles_2025.csv** dataset contains 499 rows and 4 columns. Each row represents a NBA player from the 2024-25 season. **Note** this dataset is partially cleaned from the data found at craftednba.com.
...
**Data For Worksheet Without Web Scraping**
...
| d_rtg | Defensive Rating: An esitmate of points allowed per 100 possessions
...
The **nba_shooting_2025** data contains 737 rows and 8 columns. Each row represents a NBA player from the 2024-25 season.
