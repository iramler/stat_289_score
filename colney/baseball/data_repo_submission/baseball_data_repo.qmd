...
Data courtesty of of  [baseballsavant.mlb.com](https://baseballsavant.mlb.com/){target="_blank"} and accessed using the [baseballr](https://billpetti.github.io/baseballr/){target="_blank"} package.
...
1. Are some pitch types more likely to results in home runs than others for each hitter? Investigate whether the outcome of an at-bat (from the `events` varaible) differs by pitch tpye. Do certain hitters have more success on fastballs or offspeed pitches?
