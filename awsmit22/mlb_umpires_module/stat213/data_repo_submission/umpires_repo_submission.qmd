...
3.  Obtain the p-values for each of the predictors in the model. Are all of       the predictors effective? If not, which ones and why?

4.  Fill in the anova table for the model and perform a test for the overall      fit of the model. 

5.  Record and comment on the multiple R-squared and adjusted R-squared values for the     model.

6.  Drop `bb_pct` from the model and record the new multiple R-squared and adjusted        R-squared values. Is the model without `bb_pct` better or worse?
