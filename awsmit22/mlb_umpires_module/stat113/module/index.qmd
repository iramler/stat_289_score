...
This activity could be used as a take home or in class assignment.
:::
...
1.  Examine the distribution of variables
2.  Identify outliers
:::

::: {.callout-note collapse="true" title="Methods" appearance="minimal"}
Students will utilize a basic understanding of statistical software to find means and standard deviations. Students use the IQR method to identify potential outliers. Students will also use a basic understanding of histograms to examine the distribution of variables. 
:::
...
[Worksheet](umpires_113_worksheet_tech.docx)

[Worksheet Answers](umpires_113_KEY.docx)

::: {.callout-note collapse="true" title="Conclusion" appearance="minimal"}
After finishing this activity, students should be able to assess the distribution of a variable. They shoulda lso be able to use summary statistics to identify any outliers.
:::
