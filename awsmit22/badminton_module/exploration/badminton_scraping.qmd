...
```{r}
ws2023 <- testws2023 |> separate(c("Cat"), into = c("Gender", "Category"), sep = 1) |> mutate(Category = str_replace_all(Category, "S", "Singles")) |> mutate(Gender = str_replace_all(Gender, "W", "Women")) |> rename(Player1 = Players, Opponent1 = Opponents) |> mutate(Year = 2023)
```
...
```{r}
wd2023 <- testwd2023 |> separate(Players, into = c("Player1", "Player2"), sep = " / ") |> separate(Opponents, into = c("Opponent1", "Opponent2"), sep = " / ") |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "W", "Women")) |> mutate(Category = str_replace_all(Category, "D", "Doubles")) |> mutate(Year = 2023)
```
...
```{r}
ms2023 <- testms2023 |> rename(Player1 = Players, Opponent1 = Opponents) |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "M", "Men")) |> mutate(Category = str_replace_all(Category, "S", "Singles")) |> mutate(Year = 2023)
```
...
```{r}
md2023 <- testmd2023 |> separate(Players, into = c("Player1", "Player2"), sep = " / ") |> separate(Opponents, into = c("Opponent1", "Opponent2"), sep = " / ") |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "M", "Men")) |> mutate(Category = str_replace_all(Category, "D", "Doubles")) |> mutate(Year = 2023)
```
...
```{r}
mixed2023 <- testxd2023 |> separate(Players, into = c("Player1", "Player2"), sep = " / ") |> separate(Opponents, into = c("Opponent1", "Opponent2"), sep = " / ") |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "X", "Mixed")) |> mutate(Category = str_replace_all(Category, "D", "Doubles")) |> mutate(Year = 2023)
```
...
```{r}
ws2022 <- testws2022 |> separate(c("Cat"), into = c("Gender", "Category"), sep = 1) |> mutate(Category = str_replace_all(Category, "S", "Singles")) |> mutate(Gender = str_replace_all(Gender, "W", "Women")) |> rename(Player1 = Players, Opponent1 = Opponents) |> mutate(Year = 2022)
```
...
```{r}
wd2022 <- testwd2022 |> separate(Players, into = c("Player1", "Player2"), sep = " / ") |> separate(Opponents, into = c("Opponent1", "Opponent2"), sep = " / ") |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "W", "Women")) |> mutate(Category = str_replace_all(Category, "D", "Doubles")) |> mutate(Year = 2022)
```
...
```{r}
ms2022 <- testms2022 |> rename(Player1 = Players, Opponent1 = Opponents) |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "M", "Men")) |> mutate(Category = str_replace_all(Category, "S", "Singles")) |> mutate(Year = 2022)
```
...
```{r}
md2022 <- testmd2022 |> separate(Players, into = c("Player1", "Player2"), sep = " / ") |> separate(Opponents, into = c("Opponent1", "Opponent2"), sep = " / ") |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "M", "Men")) |> mutate(Category = str_replace_all(Category, "D", "Doubles")) |> mutate(Year = 2022)
```
...
```{r}
mixed2022 <- testxd2022 |> separate(Players, into = c("Player1", "Player2"), sep = " / ") |> separate(Opponents, into = c("Opponent1", "Opponent2"), sep = " / ") |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "X", "Mixed")) |> mutate(Category = str_replace_all(Category, "D", "Doubles")) |> mutate(Year = 2022)
```
...
```{r}
ws2021 <- testws2021 |> separate(c("Cat"), into = c("Gender", "Category"), sep = 1) |> mutate(Category = str_replace_all(Category, "S", "Singles")) |> mutate(Gender = str_replace_all(Gender, "W", "Women")) |> rename(Player1 = Players, Opponent1 = Opponents) |> mutate(Year = 2021)
```
...
```{r}
wd2021 <- testwd2021 |> separate(Players, into = c("Player1", "Player2"), sep = " / ") |> separate(Opponents, into = c("Opponent1", "Opponent2"), sep = " / ") |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "W", "Women")) |> mutate(Category = str_replace_all(Category, "D", "Doubles")) |> mutate(Year = 2021)
```
...
```{r}
ms2021 <- testms2021 |> rename(Player1 = Players, Opponent1 = Opponents) |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "M", "Men")) |> mutate(Category = str_replace_all(Category, "S", "Singles")) |> mutate(Year = 2021)
```
...
```{r}
md2021 <- testmd2021 |> separate(Players, into = c("Player1", "Player2"), sep = " / ") |> separate(Opponents, into = c("Opponent1", "Opponent2"), sep = " / ") |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "M", "Men")) |> mutate(Category = str_replace_all(Category, "D", "Doubles")) |> mutate(Year = 2021)
```
...
```{r}
mixed2021 <- testxd2021 |> separate(Players, into = c("Player1", "Player2"), sep = " / ") |> separate(Opponents, into = c("Opponent1", "Opponent2"), sep = " / ") |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "X", "Mixed")) |> mutate(Category = str_replace_all(Category, "D", "Doubles")) |> mutate(Year = 2021)
```
...
```{r}
ws2020 <- testws2020 |> separate(c("Cat"), into = c("Gender", "Category"), sep = 1) |> mutate(Category = str_replace_all(Category, "S", "Singles")) |> mutate(Gender = str_replace_all(Gender, "W", "Women")) |> rename(Player1 = Players, Opponent1 = Opponents) |> mutate(Year = 2020)
```
...
```{r}
wd2020 <- testwd2020 |> separate(Players, into = c("Player1", "Player2"), sep = " / ") |> separate(Opponents, into = c("Opponent1", "Opponent2"), sep = " / ") |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "W", "Women")) |> mutate(Category = str_replace_all(Category, "D", "Doubles")) |> mutate(Year = 2020)
```
...
```{r}
ms2020 <- testms2020 |> rename(Player1 = Players, Opponent1 = Opponents) |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "M", "Men")) |> mutate(Category = str_replace_all(Category, "S", "Singles")) |> mutate(Year = 2020)
```
...
```{r}
md2020 <- testmd2020 |> separate(Players, into = c("Player1", "Player2"), sep = " / ") |> separate(Opponents, into = c("Opponent1", "Opponent2"), sep = " / ") |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "M", "Men")) |> mutate(Category = str_replace_all(Category, "D", "Doubles")) |> mutate(Year = 2020)
```
...
```{r}
mixed2020 <- testxd2020 |> separate(Players, into = c("Player1", "Player2"), sep = " / ") |> separate(Opponents, into = c("Opponent1", "Opponent2"), sep = " / ") |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "X", "Mixed")) |> mutate(Category = str_replace_all(Category, "D", "Doubles")) |> mutate(Year = 2020)
```
...
```{r}
ws2019 <- testws2019 |> separate(c("Cat"), into = c("Gender", "Category"), sep = 1) |> mutate(Category = str_replace_all(Category, "S", "Singles")) |> mutate(Gender = str_replace_all(Gender, "W", "Women")) |> rename(Player1 = Players, Opponent1 = Opponents) |> mutate(Year = 2019)
```
...
```{r}
wd2019 <- testwd2019 |> separate(Players, into = c("Player1", "Player2"), sep = " / ") |> separate(Opponents, into = c("Opponent1", "Opponent2"), sep = " / ") |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "W", "Women")) |> mutate(Category = str_replace_all(Category, "D", "Doubles")) |> mutate(Year = 2019)
```
...
```{r}
ms2019 <- testms2019 |> rename(Player1 = Players, Opponent1 = Opponents) |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "M", "Men")) |> mutate(Category = str_replace_all(Category, "S", "Singles")) |> mutate(Year = 2019)
```
...
```{r}
md2019 <- testmd2019 |> separate(Players, into = c("Player1", "Player2"), sep = " / ") |> separate(Opponents, into = c("Opponent1", "Opponent2"), sep = " / ") |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "M", "Men")) |> mutate(Category = str_replace_all(Category, "D", "Doubles")) |> mutate(Year = 2019)
```
...
```{r}
mixed2019 <- testxd2019 |> separate(Players, into = c("Player1", "Player2"), sep = " / ") |> separate(Opponents, into = c("Opponent1", "Opponent2"), sep = " / ") |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "X", "Mixed")) |> mutate(Category = str_replace_all(Category, "D", "Doubles")) |> mutate(Year = 2019)
```
...
```{r}
ws2018 <- testws2018 |> separate(c("Cat"), into = c("Gender", "Category"), sep = 1) |> mutate(Category = str_replace_all(Category, "S", "Singles")) |> mutate(Gender = str_replace_all(Gender, "W", "Women")) |> rename(Player1 = Players, Opponent1 = Opponents) |> mutate(Year = 2018)
```
...
```{r}
wd2018 <- testwd2018 |> separate(Players, into = c("Player1", "Player2"), sep = " / ") |> separate(Opponents, into = c("Opponent1", "Opponent2"), sep = " / ") |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "W", "Women")) |> mutate(Category = str_replace_all(Category, "D", "Doubles")) |> mutate(Year = 2018)
```
...
```{r}
ms2018 <- testms2018 |> rename(Player1 = Players, Opponent1 = Opponents) |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "M", "Men")) |> mutate(Category = str_replace_all(Category, "S", "Singles")) |> mutate(Year = 2018)
```
...
```{r}
md2018 <- testmd2018 |> separate(Players, into = c("Player1", "Player2"), sep = " / ") |> separate(Opponents, into = c("Opponent1", "Opponent2"), sep = " / ") |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "M", "Men")) |> mutate(Category = str_replace_all(Category, "D", "Doubles")) |> mutate(Year = 2018)
```
...
```{r}
mixed2018 <- testxd2018 |> separate(Players, into = c("Player1", "Player2"), sep = " / ") |> separate(Opponents, into = c("Opponent1", "Opponent2"), sep = " / ") |> separate(Cat, into = c("Gender", "Category"), sep = 1) |> mutate(Gender = str_replace_all(Gender, "X", "Mixed")) |> mutate(Category = str_replace_all(Category, "D", "Doubles")) |> mutate(Year = 2018)
```
...
badminton <- full_join(all23_20, all19_18)
```

# Write csv file

```{r}
write.csv(badminton, "badminton.csv")
```
