...
# Last minute cleaning with full dataset

```{r}
badminton <- badminton |> relocate(Player1, Player2, Opponent1, Opponent2, Rank, Year, Gender, Category) |> mutate(Rank = as.integer(Rank))
```
