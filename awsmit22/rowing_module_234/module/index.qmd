...
This activity could be used as an example or a short take home assessment. Best to use as a predecessor to the STAT213 level worksheets in the other rowing module. 
:::
...
Students will use basic Dplyr skills to structure data to match the descriptions listed in the questions.  
:::

::: {.callout-note collapse="true" title="Technology Requirements" appearance="minimal"}
All the questions will require the use of R and the tidyverse package. 
:::
...
This dataprep worksheet helps students familiarize themselves with the use of basic Dplyr tools to structure data in a way that is easier to analyze. In doing so, it enables to students to draw conclusions about different patterns in rowing as an Olympic sport when it comes to medalling. 
:::
