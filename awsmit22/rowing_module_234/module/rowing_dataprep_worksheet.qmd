...
**The questions in this worksheet involve data 234 level questions. The goal of these questions are to tidy the data so that it can be used for the worksheets in the STAT213 version of this model.**
