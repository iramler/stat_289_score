...
ggplot(medals_hist, aes(x = points)) + geom_histogram(fill = "lightblue", colour = "black", bins = 20) + theme_minimal() + labs(title = "Histogram of points for all countries in all events")
```
