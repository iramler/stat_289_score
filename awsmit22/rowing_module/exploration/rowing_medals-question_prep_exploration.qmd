...
ggplot(data = medals_reordered, aes(x = NOC, y = total_medals)) + geom_col(fill = "lightblue", colour = "grey") + coord_flip() + theme_minimal() + labs(title = "Bar plot of total_medals ranked by NOC")
```
