...
```{r}
athletes_df <- read_csv("/Users/abigailsmith/Desktop/stat289/awsmit22/rowing_module/data_repo_submission/athlete_events.csv")
```
...
```{r}
events_athletes <- read_csv("~/Desktop/stat289/awsmit22/rowing_module/exploration/events_athletes.csv")
```
