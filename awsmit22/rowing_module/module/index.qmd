...
Students will use an understanding of histograms and summary statistics to assess data distribution. Students will also use the IQR formula to identify outliers as well as be able to have a basic understanding of confounding variables. 

:::

::: {.callout-note collapse="true" title="Technology Requirements" appearance="minimal"}
Only question 2 will require the use of statistical software, all of the other questions should only require a calculator if need be. 
:::
