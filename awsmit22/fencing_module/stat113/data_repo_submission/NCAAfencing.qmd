...
: [NCAAFencingIndividuals.csv](NCAAFencingIndividuals.csv){target="_blank"}

## Questions

1.    Create a subset for Ivies and another for Non-Ivies. Write down the number of Ivy students       and the number of Non-Ivy students.

2.    Find the mean Victories for Ivies and Non-Ivies.

3.    Find the standard deviation of Victories for Ivies and Non-Ivies.

4.    Create a side-by-side boxplot of Victories for Ivies and Non-Ivies, compare the                  distributions.

5.    Test for a discernible difference in the mean number of victories for ivy league             fencers and non-ivy league fencers. 
