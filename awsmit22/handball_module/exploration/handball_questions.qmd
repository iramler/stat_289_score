...
```{r}
handball_clean <- read_csv("~/Desktop/git/stat_289_score/awsmit22/handball_module/data_repo_submission/handball.csv")
```
...
***Just noticed that i should have a question interpreting the slope for the model***
# Question 3
