...
2.  Assess the overall fit of a multiple linear regression model using ANOVA
3.  Interpret multiple linear regression coefficients
4.  Discern the difference between prediction and confidence intervals in regression
5.  Find and interpret prediction and confidence intervals using statistical software
...
[Kaggle Bundesliga 2022-23 Stats
