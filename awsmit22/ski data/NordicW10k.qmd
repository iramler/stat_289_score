...
1.  Create a scatterplot of Time1 against Rank4. Does there seem to be a
...
3.  Make a model of Rank4 predicted by Time1. Interpret the coefficient
    of Time1.

4.  Make a boxplot of the NSA variable against Rank4. What is the
    distribution of each Nation? Do some have a bigger range than
    others?
