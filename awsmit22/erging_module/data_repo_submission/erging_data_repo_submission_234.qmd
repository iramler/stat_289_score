...
2.  Describe the distribution of the plot.
...
6.  Perform a t.test to evaluate if there is a significant difference in the mean `Speed` for `Verified` and `Non-Verified` pieces.
...
9.  Comment on the distribution of this new boxplot.

10.  Perform a t.test with the new dataset and re-evalute if there is a significant difference in the mean `Speed` for `Verified` and `Non-Verified` pieces.
