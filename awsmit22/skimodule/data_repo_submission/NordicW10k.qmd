...
2.    Make a model of Rank4 predicted by Bib. Interpret the coefficient of Bib.

3.    Use an ANOVA for means test to decide if there is a considerable difference in the mean speed for each time interval. First, perform the test by constructing a one-way ANOVA model for means by hand. Then, check it by running it through R. 

## References

[results]()
(https://live.fis-ski.com/cc-2257/results-pda.htm){target = "_blank"}
