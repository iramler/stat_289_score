...
3.    Use an ANOVA for means test to decide if there is a considerable difference in the mean time for each time interval. First, perform the test by constructing a one-way ANOVA model for means by hand. Then, check it by running it through R. 
