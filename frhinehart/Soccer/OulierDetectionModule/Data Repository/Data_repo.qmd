 ...
 * Renamed women's variables to match men's variables 
 * Added a Sex variable 
 * Removed variable's in the Men's dataset to match women's variables
 * Combined the two different datasets into one 
 * Removed OWN GOAL, TOTALS, and OPPONENT TOTALS from dataset
...
1. Can outlier's be detected using a fitted model?
2. Can we determine a outlier influence on a regression model?
