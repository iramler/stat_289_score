...
The powerlifting data contains 6497 records of female competitors from the open powerlifting data set. 

Data is available on the SCORE [Data Repository Website](https://data.scorenetwork.org/){target="_blank"}

Download data: [openpl_sample_female.csv](https://data.scorenetwork.org/data/openpl_sample_female.csv){target="_blank"}

Similar data for male powerlifters is available at [https://data.scorenetwork.org/powerlifting/openpowerlifting.html](https://data.scorenetwork.org/powerlifting/openpowerlifting.html){target="_blank"}
