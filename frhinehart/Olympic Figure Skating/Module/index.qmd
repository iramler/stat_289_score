...
Students are expected to understand the concept of hypothesis forming, rejecting hypothesi, confidence intervals and interpreting output. Students are also expected to now how to code basic ggplots, fit models, and use functions in R Studio.
