---
title: "2025 Women's Track Running: Intro to Non Linear Least Squares Regression"
author:
  - name: Phoebe Jones
    affiliation:
      - id: slu
...
date: "July 8, 2025"
description: "Using data from 2025 D1 Women's track to observe the use case of nls models."
editor: 
  canonical: true
categories:
...
This could be used as an out-of-class homework assignment or an in-class activity that should take around an hour.
:::

::: {.callout-note collapse="true" title="Learning Objectives" appearance="minimal"}
By the end of this activity, students will:

1.  Have a greater understanding of the practical applications of NLS models
2.  Know how to apply NLS models to their data
3.  Be comfortable comparing NLS models to each other and to linear models
:::

::: {.callout-note collapse="true" title="Methods" appearance="minimal"}
Students will need to have a strong knowledge of linear least squares regression.
:::

::: {.callout-note collapse="true" title="Technology Requirements" appearance="minimal"}
Students will need to have access to RStudio.
:::
...
[Module Worksheet](2025_Track_NLS_worksheet.qmd){target="_blank"}

[Solutions to Worksheet (R/Quarto version)](2025_Track_NLS_SOLUTIONS.qmd){target="_blank"}

[Solutions to Worksheet (pdf)](2025_Track_NLS_SOLUTIONS.pdf){target="_blank"}

::: {.callout-note collapse="true" title="Conclusion" appearance="minimal"}
Upon conclusion of this module, students will have a greater understanding of non-linear least squares regression models and their use cases.
:::
