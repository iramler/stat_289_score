...
**Download Running Data:** [WomensTrack2025.csv](WomensTrack2025.csv){target="_blank"}

## Questions

1. How can we separate `Athlete` into first and last name variables?
2. How can we create a speed variable to observe the relationship between distance and speed?
3. Do some meets produce unusual times?
4. What is the average time for each event?
5. How can we characterize the relationship between speed and distance?
