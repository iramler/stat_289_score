...
Students should have had an introduction to with normal distributions, histograms, boxplots, and summary statistics.

:::

::: {.callout-note collapse="true" title="Technology Requirements" appearance="minimal"}

Students may need access to a calculation (of any sort).
...
Upon conclusion of this module, students will have a greater understanding 
:::
