...
Students should have introductory experience with both creating graphs and filtering data.

:::

::: {.callout-note collapse="true" title="Technology Requirements" appearance="minimal"}

Students will need to use technology that supports creation of graphs and filtering of data.
...
[Module Worksheet (R Version)](clinton_module_worksheet.qmd){target="_blank"}

[Module Worksheet (non-R Version)](Clinton_DataVis_Graphing.docx)

[Solutions to Worksheet (R Version)](clinton_module_SOLUTIONS.qmd){target="_blank"}
