...
Each row in the `full_clinton` data set represents a specific paddler from a year of the Clinton. This data set contains results from 2014-2025 (excluding 2020 and 2021, when the race was cancelled due to the Covid-19 Pandemic).
...
**Download Clinton Data:** [full_clinton.csv](full_clinton.csv){target="_blank"}


## Questions

1. Make various differ plots based on a data set. What can they tell you?

2. Filter a data set based on context

3. Identify an issue with data based on a plot
