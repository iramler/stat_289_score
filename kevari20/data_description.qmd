...
The `wnba_data` data set contains 8920 rows and 9 columns. Each row represents a single game played by a WNBA team in one of the 2003 to 2022 regular seasons. The columns are as follows: 
