...
-   Up to date statistics can be obtained from the [DGPT24 data extraction.qmd](DGPT24 data extraction.qmd)
...
The data is obtained from the PDGA's official statistics provider [StatMando](https://statmando.com/).

### Materials

[DGPT.csv](DGPT.csv) - data set containing statistics from the 2024 DGPT season

[DGPT24 questions.docx](DGPT24 questions.docx) - questions about correlation between total earnings and putting and driving

Solutions for questions

[DGPT24 questions ans.docx](DGPT24 questions ans.docx)


[DGPT24 data extraction.qmd](DGPT24 data extraction.qmd) - code for scraping updated DGPT data from the StatMando website
