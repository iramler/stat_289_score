...
```{r}
dgpt <- read.csv("/Users/Gavin Cassidy/Desktop/GitHub/stat_289_score/gacass21/data repo/DGPT.csv")

dgpt2 <-  dgpt |> select(-1, -2, -4, -5, -9, -10, -15, -16, -17, -18, -20, -21, -22, -23, -25) |>
  select(2, 3, 4, 7, 5, 6, 8, 1, 9, 10)
...
```{r}
dgpt_reg <- lm(total_earnings ~ C1R + , data = dgpt)
summary(dgpt_reg)
```
