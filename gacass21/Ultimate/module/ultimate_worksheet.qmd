...
Starting with the ultimate_statistics dataset, make the dataset in a tidy format using the pivot_wider() function, use pivot wider on ultimate_games as well.
