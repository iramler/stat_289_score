...
Starting with the ultimate_statistics dataset, make the dataset in a tidy format using the pivot_wider() function. There should be 1 row for each player that includes all statistics.
