...
```{r}
per_game <- read.csv("/Users/Gavin Cassidy/Desktop/GitHub/stat_289_score2/gacass21/exploration/ultimate_per_game.csv")
total_stats <- read.csv("/Users/Gavin Cassidy/Desktop/GitHub/stat_289_score2/gacass21/exploration/ultimate_total.csv")
```
...
```{r}
div_3_w |> arrange(desc(Turns)) |> summarise(Player, Turns, Ds, Assists, Points, `Plus Minus`, `Team Games`)
```
