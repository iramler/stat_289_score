...
-   Up to date statistics can be obtained from the [DGPT24 data extraction.qmd](DGPT24%20data%20extraction.qmd)
:::
...
[DGPT24 questions.docx](DGPT24%20questions.docx) - questions about correlation between total earnings and putting and driving

Solutions for questions: [DGPT24 questions ans.docx](DGPT24%20questions%20ans.docx)

Code for scraping data [DGPT24 data extraction.qmd](DGPT24%20data%20extraction.qmd) - code for scraping updated DGPT data from the StatMando website
