...
2b. Make gender a factored variable.

3c. Get rid of country_code, discipline_code, residence_place, residence_country, and url.

4d. See if you can figure out how to separate the height variable into just meters and convert it into a numeric value.
...
### Exercise 2
Using the example above and the filter function in the dplyr package, lets see which country has the most gold medal winners using either medal_type.
