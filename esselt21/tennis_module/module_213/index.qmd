...
2.  Understand interaction terms and why they should be used.
...
There is one data set for this exercise. The data is made up of 111 rows and 8 columns and is provided by Wheelo Ratings. Each row represents a player on a given surface

Download data: [wta](data/wta.csv)
