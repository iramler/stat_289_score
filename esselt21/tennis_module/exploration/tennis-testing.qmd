...
wta <- read.csv(here::here("esselt21/tennis_module/data_repo/new_wta.csv"))
```
...
model_wta <- lm(WinPercentage ~ Surface*Matches + EloRank + ReturnPointsWonPercentage + AcesPerDoubleFault + AcesPerDoubleFault*Surface,
            data = wta)
summary(model_wta)
aug_wta <-
  augment(model_wta)
