...
## Motivation 
In NCAA Woman's Volleyball for the Liberty League, there are 12 teams in New York that are a part of the division. In a play by play data set, each play of every game from 2013 to 2022 was given with information about the scores, a description of the plays, when and where the games were.
