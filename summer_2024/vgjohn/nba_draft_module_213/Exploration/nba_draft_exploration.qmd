...
```{r}
library(tidyverse)
nba_draft <- read_csv("/Users/vivianjohnson/Desktop/stat_289_score_new/vgjohn/nba_draft_module_213/Exploration/nba_draft.csv")
```
...
```{r}
ggsave(filename = "DensityPlot.jpg",
       plot = density,
       width = 6,
       height = 4,
       dpi = 300)
