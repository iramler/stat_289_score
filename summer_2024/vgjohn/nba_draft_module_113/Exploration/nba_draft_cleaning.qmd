...
nba_draft<- nba_draft %>% select(-playerurl, -BPM, -VORP, -DraftYear, -Rk, -WS, -`WS/48`, -`...1`)
...
```{r}
write_csv(nba_draft,
          file = "/Users/vivianjohnson/Desktop/stat_289_score_new/vgjohn/nba_draft_module_113/nba_draft.csv")
```
