...
-   The Tech version provides the dataset and asks students to use technology to compute the needed correlations.
:::
...
[SkiToSeaCorrelationsWithTech.docx](SkiToSeaCorrelationsWithTech.docx) - Tech version of the activity worksheet that allows students to make their own correlations and plots from the provided dataset.
...
[SkiToSeaCorrelationsWithTech-Ans.docx](SkiToSeaCorrelationsWithTech-Ans.docx) - Sample solutions to the Tech version of the activity worksheet.
