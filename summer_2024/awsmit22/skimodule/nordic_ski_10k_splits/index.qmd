...
1.  Find and interpret the correlation between two variables.

2.  Fit a simple linear model.

3.  Interpret the slope of a simple linear model.

4.  Assess the conditions of a simple linear model.
:::

::: {.callout-note collapse="true" title="Methods" appearance="minimal"}

Students will use statistical software to find and assess the correlation between two variables. Additionally, students will interpret the slope of a simple linear model after fitting it using statistical software. Students will also use residual plots and histograms to evaluate the conditions of a simple linear regression model. 
:::
...
[Class handout](113_ski_worksheet.docx)

[Class handout - Key](113_ski_worksheet_key.docx)



::: {.callout-note collapse="true" title="Conclusion" appearance="minimal"}

After completing this activity, students should be able check the conditions of a linear model. The activity should strengthen an understanding of correlation between two variables. Using these skills, students can draw conclusions about patterns in skiers' pacing strategies in a 10k nordic ski race. Students can also evaluate which strategies are the most successful. 
