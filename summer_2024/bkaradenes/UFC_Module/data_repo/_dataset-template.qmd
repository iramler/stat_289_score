...
The `fight_data` dataset contains 3596 rows and 14 columns. Each row represents a fighter and their career statistics. The columns are shown below.
...
: [raw_fighter_details.csv](../data/raw_fighter_details.csv)
