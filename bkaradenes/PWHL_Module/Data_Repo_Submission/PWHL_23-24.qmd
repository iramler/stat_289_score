...
-   Explore the relationship between goals per games played and position.
-   Use dplyr to create some new variables and explain what they do.
-   Describie shape, skew, and noting any outliers of visualizations displaying the data.
