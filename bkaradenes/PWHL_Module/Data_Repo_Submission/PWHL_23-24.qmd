...
| Pos        | Position of the player, either Guard (G), Defense (D) or Forward (F) |
...
-   Create a density plot that explores the relationship between goals per games played and position. Describe the shape of each curve.
-   Which dplyr function could you use to create different age groups for the players?
-   Analyze boxplots displaying the number of points vs age groups of the players by describing shape, skew, and noting any outliers.
