...
For this activity, you will be exploring the event times for male and female swimmers that competed in the 100m event from 1924 to 2020 in the [Olympics](https://olympics.com/en/paris-2024/sports/swimming){target="_blank"}.

In particular, you will examine visualizations and conduct hypothesis tests to explore the changes in finish times between different types of strokes and earlier vs. recent years.
...
3.  Assess differences between two samples using hypothesis tests.
:::

::: {.callout-note collapse="true" title="Methods" appearance="minimal"}
For this activity, students will primarily use basic concepts of boxplots and hypothesis tests to analyze data. Students will also likely require knowledge of the t-statistic.
:::

::: {.callout-note collapse="true" title="Technology Requiremens" appearance="minimal"}
The provided worksheets require StatKey or similar software to get the p-value. They will also require access to a calculator.
...
The data set contains 606 rows and 10 columns. Each row represents a swimmer who competed in the 100m Olympic event during the period 1924 to 2020.
...
[Kaggle](https://www.kaggle.com/datasets/datasciencedonut/olympic-swimming-1912-to-2020){target="_blank"}
...
In conclusion, the Olympic swimming module provides valuable opportunities for students in several important areas. It allows them to understand how to interpret visuals  
:::
