...
In theory, the point spread makes the game a toss up, so either team has a 50% chance of winning.  In practice, the point spreads are often chosen to try to get an equal number of fans to take either side of the bet. We use point spreads from [ESPN's Pigskin Pick'em Game](https://fantasy.espn.com/games/nfl-pigskin-pickem-2024/) which are all in "half points" (1.5, 2.5, etc.) so there is always a "winner" against the points. 
