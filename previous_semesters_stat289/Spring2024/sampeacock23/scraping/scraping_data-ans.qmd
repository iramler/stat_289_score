...
-   The main difference is that the leg number starts at 2 and increases by 7 for each additional year; however, the event does not change.
...
-   After looking through the results from the website, we see that the leg numbers increase by 7 each year.
...
Join these data files to create one data set with each row to represent a team name for a given year and the columns represent the minutes for each leg completion.
